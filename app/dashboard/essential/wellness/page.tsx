        ...
        <div className="grid gap-4 md:grid-cols-2">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-medium">First Spa Session Complete</h3>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-medium">Initial Health Assessment</h3>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-medium">Wellness Program Orientation</h3>
                    <p className="text-sm text-muted-foreground">Completed on January 20, 2024</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Wellness programs and activities</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="rounded-lg border p-4">
                  <h3 className="font-medium">4N/5D Wellness Stay</h3>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="font-medium">Startup Metrics Consultation</h3>
                  <p className="text-sm text-muted-foreground mb-4">Identify and optimize your key business metrics</p>
                  <Button className="w-full">Schedule Session</Button>
                </div>
                <div className="rounded-lg border p-4">
                  <h3 className="font-medium">Basic Health Assessment</h3>
                  <p className="text-sm text-muted-foreground mb-4">Initial health and wellness evaluation</p>
