              ...
              <div className="bg-[#FAF9F6] rounded-xl p-6">
                <div className="flex flex-col gap-6">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground font-['Marcellus']">Amount Paid</span>
                    <span className="font-semibold text-green-700 text-xl">₹{invoiceStatus?.amount || '—'}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground font-['Marcellus']">Payment Method</span>
