...
export function MembershipDetailsModal({ isOpen, onClose, membership, handleTakeMembership }: MembershipDetailsModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[800px] p-0 overflow-hidden rounded-xl w-[92%] sm:w-full mx-auto max-h-[90vh] sm:max-h-[85vh] overflow-y-auto">
        <DialogTitle className="sr-only">Ode Spa Membership</DialogTitle>
        <div className="bg-[#a07735] p-3 sm:p-4 rounded-t-l text-center">
        ...
        <div className="px-0 pt-0 pb-0 rounded-t-2xl text-center relative">
          <div className="flex items-center justify-between px-4 sm:px-8 pt-4 sm:pt-6 pb-2">
            <button
              className="hover:text-[#a07735] text-base sm:text-lg font-bold font-inter flex items-center gap-1.5 sm:gap-2"
              onClick={onClose}
              aria-label="Back"
            >
            ...
            <div className="flex-1 flex flex-col items-center">
              <h1 className="text-xl sm:text-2xl font-bold font-marcellus mb-0.5 sm:mb-1">
                {typeof membership.price === 'object' && membership.price?.sales 
                  ? `₹${membership.price.sales.toLocaleString()}`
                  : String(membership.price || '')}
              </h1>
            </div>
            <div className="w-[100px] sm:w-[140px] flex justify-end">
              <Button 
                className="relative w-[120px] sm:w-[300px] h-[32px] sm:h-[36px] p-3 sm:p-6 bg-gradient-to-r from-[#E6B980] to-[#F8E1A0] shadow-[0px_2px_4px_rgba(0,0,0,0.1),0px_4px_6px_rgba(0,0,0,0.1)] rounded-xl font-['Marcellus'] font-bold text-sm sm:text-[20px] leading-[17px] text-center text-[#98564D]"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-8 bg-white">
          <div className="bg-[#f5f1e8] rounded-xl p-4 sm:p-6 flex flex-col shadow-sm">
            <div className="flex items-center mb-2">
              <svg width="20" height="20" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-[25px] sm:h-[25px]">
              ...
              <h1 className="font-semibold text-lg sm:text-[22px] text-[#98564d] ml-3 sm:ml-4">Benefits</h1>
            </div>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-[#454545]">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 min-w-[16px] sm:min-w-[20px] min-h-[16px] sm:min-h-[20px] text-[#98564d] mt-0.5" />
                <span className="font-inter">Flat 5% OFF on all subsequent bookings after redemption</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 min-w-[16px] sm:min-w-[20px] min-h-[16px] sm:min-h-[20px] text-[#98564d] mt-0.5" />
                <span className="font-inter">10% OFF on ODE skincare and wellness products</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 min-w-[16px] sm:min-w-[20px] min-h-[16px] sm:min-h-[20px] text-[#98564d] mt-0.5" />
                <span className="font-inter">Birthday month special: One free head massage</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-[#f5f1e8] rounded-xl p-4 sm:p-6 flex flex-col shadow-sm">
            <div className="flex items-center mb-2">
              <svg width="24" height="20" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-5 sm:w-[30px] sm:h-[24px]">
              ...
              <h1 className="font-semibold text-lg sm:text-[22px] text-[#98564d] ml-3 sm:ml-4">Terms</h1>
            </div>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-[#454545]">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 min-w-[16px] sm:min-w-[20px] min-h-[16px] sm:min-h-[20px] text-[#98564d] mt-0.5" />
                <span className="font-inter">Non-transferable</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 min-w-[16px] sm:min-w-[20px] min-h-[16px] sm:min-h-[20px] text-[#98564d] mt-0.5" />
                <span className="font-inter">Cannot be clubbed with other promotional offers</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 min-w-[16px] sm:min-w-[20px] min-h-[16px] sm:min-h-[20px] text-[#98564d] mt-0.5" />
                <span className="font-inter">Advance booking recommended on weekends</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-[#f5f1e8] rounded-xl p-4 sm:p-6 flex flex-col shadow-sm">
            <div className="flex items-center mb-2">
              <svg width="24" height="24" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 sm:w-[30px] sm:h-[30px]">
              ...
              <h1 className="font-semibold text-lg sm:text-[22px] text-[#98564d] ml-3 sm:ml-4">Discounts & Offers</h1>
            </div>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-[#454545]">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 min-w-[16px] sm:min-w-[20px] min-h-[16px] sm:min-h-[20px] text-[#98564d] mt-0.5" />
          ...
          <div className="bg-[#f5f1e8] rounded-xl p-4 sm:p-6 flex flex-col shadow-sm">
            <div className="flex items-center mb-2">
              <svg width="18" height="20" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-5 sm:w-[21px] sm:h-[24px]">
              ...
              <h1 className="font-semibold text-lg sm:text-[22px] text-[#98564d] ml-3 sm:ml-4">Validity</h1>
            </div>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-[#454545]">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 min-w-[16px] sm:min-w-[20px] min-h-[16px] sm:min-h-[20px] text-[#98564d] mt-0.5" />
                <span className="font-inter">12 months from the date of activation</span>
              </li>
            </ul>
          </div>
        </div>
